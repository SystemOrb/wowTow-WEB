...
export class AppComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this._router = this.router.events.filter(event => event instanceof NavigationEnd).subscribe((event: NavigationEnd) => {
            ...
            this.renderer.listenGlobal('window', 'scroll', (): void => {
                ...
                if (this.location.path() !== '/sections') {
                    ...
                    } else if (_location !== 'addproduct' && _location !== 'blogposts'
                    &&  _location !== 'discover' && _location !== 'contactus'
                    && _location !== 'login' && _location !== 'register'
                    && _location !== 'search'
